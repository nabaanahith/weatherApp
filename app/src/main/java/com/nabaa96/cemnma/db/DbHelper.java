...
public class DbHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "user_weather00129.db";
    private static final int DATABASE_VERSION = 2;
    final String SQL_CREATE_TABLE = "CREATE TABLE " + UserContacts.FavoriteEntry.TABLE_NAME + " ("
            + UserContacts.FavoriteEntry.USER_ID + " INTEGER PRIMARY KEY, " +
    ...
    String Query2 = "select * from " + UserContacts.FavoriteEntry.TABLE_NAME +" WHERE " + UserContacts.FavoriteEntry.USER_ID +"=0"; // all times we will get forst user
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        values.put(UserContacts.FavoriteEntry.USER_ID, 0);
    ...
    public void saveUserWeatherInfo(UserWeather weather) {
        ...
        db.update(UserContacts.FavoriteEntry.TABLE_NAME, values, "userid="+ 0,null);
        db.close();
